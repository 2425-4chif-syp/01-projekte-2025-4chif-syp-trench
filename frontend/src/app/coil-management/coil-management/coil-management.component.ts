...
export class CoilManagementComponent {
  ...
  isFieldInvalid(field: string): boolean {  
    ...
    switch(field) {
      case 'coiltype':
        return !this.selectedCoil.coiltypeId || this.selectedCoil.coiltypeId === 0;
      case 'ur':
        return this.selectedCoil.ur === null || this.selectedCoil.ur === 0;
      case 'einheit':
        return this.selectedCoil.einheit === null || this.selectedCoil.einheit === 0;
      case 'auftragsnummer':
        return this.selectedCoil.auftragsnummer === null || this.selectedCoil.auftragsnummer === 0;
      case 'auftragsPosNr':
        return this.selectedCoil.auftragsPosNr === null || this.selectedCoil.auftragsPosNr === 0;
      case 'omega':
        return this.selectedCoil.omega === null || this.selectedCoil.omega === 0;
      default:
        return false;
    }
  }
