...
export class DisplacementVisualizationTestComponent {
  private static readonly uniformValues:boolean = false;

  yokes = signal<{sensors:number[]}[]>(DisplacementVisualizationTestComponent.uniformValues ? 
    [{ sensors: [1000, 1000, 1000, 1000, 1000, 1000] },
    { sensors: [1000, 1000, 1000, 1000, 1000, 1000] },
    { sensors: [1000, 1000, 1000, 1000, 1000, 1000] }] : [
